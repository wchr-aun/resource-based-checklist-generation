...
const Task1FollowUp: NextPage = () => {
  ...
  const callGenerateApi = async () => {
    ...
    Router.push("/evaluation/task/1/follow-up/canvas");
  };

  return (
    <div className="space-y-2 mb-8">
      <Head>
        <title>Task 1 Follow-up - Resource-based Checklist Generation</title>
      </Head>
      <div className="border border-transparent rounded-lg bg-white py-8 px-16 text-center space-y-5">
        <div className="text-bold text-3xl underline">Task 1 Follow-up</div>
