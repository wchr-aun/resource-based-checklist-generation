    ...
    <div className="space-y-2 mb-8">
      ...
      <div className="border border-transparent rounded-lg bg-white py-8 px-16 text-center space-y-5">
        ...
        <div className="text-left">
          ...
          that blocks the service. The process contains two input information
          namely "OpenContract" and "PendingHealthcareService" and expects the
          output to be either 1.) "CompletedHealthcareService" or 2.) "Obstacle"
          and "PendingHealthcareService".
          <br />
          <br />
