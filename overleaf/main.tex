...
\abstract{
\input{overleaf/chapters/abstraction}
}
...
\input{overleaf/chapters/acknowledgements}
...
\input{overleaf/chapters/introduction}

\chapter{Background}

\input{overleaf/chapters/background}
...
% % % user diagram
% \input{overleaf/chapters/methodology}

\chapter{Design}
\input{overleaf/chapters/design}

\chapter{Implementation}
\input{overleaf/chapters/implementation}

\chapter{Evaluation and Results}
% results
\input{overleaf/chapters/evaluation}

\chapter{Conclusions}
% what the work was, what we did, how we evaluated, what the results were, recommendation for future works
\input{overleaf/chapters/conclusions}
